...
<body>
    <header>
        <nav>
            ...
            <div class="end_bx">
                ...
                <a style="color:#fff;" href="RetrieveData?argumentName=<%= username %>"><%= username %></a>
                </div>
            </div>
        </nav>
        <!-- End of Header -->
    ...
    <!-- video box start  -->
    <div class="video_bx">
        <video src="video/potc.mp4" id="video"></video>
        <div class="control">
            <div class="play_redo">
        ...
        <h4 class="title_video">Rampage trailer hd coming soon</h4>
        ...
        <div class="video_list">
            <img src="img/121213.jpg" alt="" class="video_1">
            <img src="img/121214.jpg" alt="" class="video_1">
            <img src="img/121215.jpg" alt="" class="video_1">
        </div>
    </div>
    <!-- video box end  -->

	<div class="review">
             <a href="addReview.jsp"> <input type="button" value="Add review"></a> 
    </div>
